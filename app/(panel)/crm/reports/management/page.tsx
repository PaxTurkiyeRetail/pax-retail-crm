...
export default function ManagementReportPage() {
  ...
  const filteredRows = useMemo(() => rows.filter((row) => {
    ...
    if (kunyeFilter && (row.kunye_durumu ?? '-') !== kunyeFilter) return false;
    return true;

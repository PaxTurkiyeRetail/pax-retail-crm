...
-- =====================================================================
-- Vertical iş kolu sektörleri (Seda ile 26.08.2026 toplantısı, eski
-- 20260826_005_vertical_sektorleri.sql migration'ından taşındı).
--
-- Genel "Vertical" sektör başlığı yerine seçilebilir gerçek sektörler
-- tanımlanır. Etikette "Vertical" öneki KULLANILMAZ; iş kolu bilgisi
-- meta.business_line alanında tutulur. Raporlar (satışçı sunumu başlığı
-- vb.) Vertical ayrımını bu meta alanından yapar — bkz.
-- lib/weekly-management-presentation.ts.
-- =====================================================================

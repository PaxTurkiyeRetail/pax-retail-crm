...
-- AmaÃ§: hard-code edilen liste/degerleri DB'den yÃ¶netilebilir hale getirmek.
-- Admin/Super Admin Parametre YÃ¶netimi ekranÄ± bu tabloyu kullanÄ±r.
...
values
  ('activity_status', 'baslamadi', 'BaÅŸlamadÄ±', 'BaÅŸlamadÄ±', 10, '{"source":"seed"}'::jsonb),
  ...
  ('activity_status', 'tamamlandi', 'TamamlandÄ±', 'TamamlandÄ±', 40, '{"source":"seed"}'::jsonb),
  ('activity_status', 'ihtiyac_duyulmadi', 'Ä°htiyaÃ§ DuyulmadÄ±', 'Ä°htiyaÃ§ DuyulmadÄ±', 50, '{"source":"seed"}'::jsonb),
  ...
  ('sales_probability', 'dusuk', 'DÃ¼ÅŸÃ¼k', 'DÃ¼ÅŸÃ¼k', 10, '{"source":"seed"}'::jsonb),
  ('sales_probability', 'orta', 'Orta', 'Orta', 20, '{"source":"seed"}'::jsonb),
  ('sales_probability', 'yuksek', 'YÃ¼ksek', 'YÃ¼ksek', 30, '{"source":"seed"}'::jsonb),
  ...
  ('kunye_sabit_kasa_adedi', 'kullanilmiyor', 'KullanÄ±lmÄ±yor', 'KullanÄ±lmÄ±yor', 10, '{"source":"seed"}'::jsonb),
  ...
  ('kunye_kasapos_firmasi', 'diger', 'DiÄŸer', 'DiÄŸer', 999, '{"source":"seed"}'::jsonb),

  ('kunye_pos_modeli', 'okc', 'Ã–KC', 'Ã–KC', 10, '{"source":"seed"}'::jsonb),
  ...
  ('kunye_pos_markasi', 'diger', 'DiÄŸer', 'DiÄŸer', 999, '{"source":"seed"}'::jsonb),

  ('kunye_alim_yili', '1_yildan_az', '1 yÄ±ldan az', '1 yÄ±ldan az', 10, '{"source":"seed"}'::jsonb),
  ('kunye_alim_yili', '1_3_yil', '1-3 yÄ±l', '1-3 yÄ±l', 20, '{"source":"seed"}'::jsonb),
  ('kunye_alim_yili', '3_5_yil', '3-5 yÄ±l', '3-5 yÄ±l', 30, '{"source":"seed"}'::jsonb),
  ('kunye_alim_yili', '5_yil', '5+ yÄ±l', '5+ yÄ±l', 40, '{"source":"seed"}'::jsonb),
  ...
  ('kunye_bilgisayar_markasi', 'diger', 'DiÄŸer', 'DiÄŸer', 999, '{"source":"seed"}'::jsonb),

  ('kunye_evet_hayir', 'hayir', 'HayÄ±r', 'HayÄ±r', 10, '{"source":"seed"}'::jsonb),
  ...
  ('kunye_odeme_yazilimi', 'diger', 'DiÄŸer', 'DiÄŸer', 999, '{"source":"seed"}'::jsonb),
  ...
  ('kunye_reyon_cihaz_modeli', 'diger', 'DiÄŸer', 'DiÄŸer', 999, '{"source":"seed"}'::jsonb),
  ...
  ('kunye_el_terminali_modeli', 'diger', 'DiÄŸer', 'DiÄŸer', 999, '{"source":"seed"}'::jsonb),
  ...
  ('kunye_erp', 'diger', 'DiÄŸer', 'DiÄŸer', 999, '{"source":"seed"}'::jsonb),
  ...
  ('kunye_banka', 'is_bankasi', 'Ä°ÅŸ BankasÄ±', 'Ä°ÅŸ BankasÄ±', 30, '{"source":"seed"}'::jsonb),
  ('kunye_banka', 'yapi_kredi', 'YapÄ± Kredi', 'YapÄ± Kredi', 40, '{"source":"seed"}'::jsonb),
  ('kunye_banka', 'halkbank', 'Halkbank', 'Halkbank', 50, '{"source":"seed"}'::jsonb),
  ('kunye_banka', 'vakifbank', 'VakÄ±fBank', 'VakÄ±fBank', 60, '{"source":"seed"}'::jsonb),
  ('kunye_banka', 'ziraat_bankasi', 'Ziraat BankasÄ±', 'Ziraat BankasÄ±', 70, '{"source":"seed"}'::jsonb),
  ...
  ('kunye_saha_hizmeti_firmasi', 'diger', 'DiÄŸer', 'DiÄŸer', 999, '{"source":"seed"}'::jsonb),
  ('kunye_memnuniyet', 'memnun', 'Memnun', 'Memnun', 10, '{"source":"seed"}'::jsonb),
  ('kunye_memnuniyet', 'orta', 'Orta', 'Orta', 20, '{"source":"seed"}'::jsonb),
  ('kunye_memnuniyet', 'memnun_degil', 'Memnun DeÄŸil', 'Memnun DeÄŸil', 30, '{"source":"seed"}'::jsonb)
on conflict (group_key, param_key) do nothing;


-- Sistem davranÄ±ÅŸ parametreleri: tekrar Ã§alÄ±ÅŸtÄ±rÄ±ldÄ±ÄŸÄ±nda mevcut kayÄ±tlarÄ± deÄŸiÅŸtirmez.
insert into public.system_parameters (group_key, param_key, label, value, sort_order, meta)
values
  ('system_jira_enabled', 'aktif', 'Aktif', 'true', 10, '{"source":"seed","module":"Sistem DavranÄ±ÅŸlarÄ±","category":"Jira"}'::jsonb),
  ('system_jira_weekly_pptx_enabled', 'aktif', 'Aktif', 'true', 10, '{"source":"seed","module":"Sistem DavranÄ±ÅŸlarÄ±","category":"Jira"}'::jsonb),
  ('system_jira_debug_enabled', 'aktif', 'Aktif', 'true', 10, '{"source":"seed","module":"Sistem DavranÄ±ÅŸlarÄ±","category":"Jira"}'::jsonb),
  ('system_pptx_download_enabled', 'aktif', 'Aktif', 'true', 10, '{"source":"seed","module":"Sistem DavranÄ±ÅŸlarÄ±","category":"Rapor / PPTX"}'::jsonb),
  ('system_page_size', '25', '25', '25', 10, '{"source":"seed","module":"Sistem DavranÄ±ÅŸlarÄ±","category":"Performans"}'::jsonb)
on conflict (group_key, param_key) do nothing;


-- Eski paralel grup adları yalnız geriye dönük veri taşıma içindir; uygulama
-- kanonik crm_* gruplarını kullanır.
...
-- AD/OIDC altyapısı IT onayı ve grup eşlemeleri gelene kadar kapalı kalır.
insert into public.system_parameters (group_key, param_key, label, value, sort_order, is_active, meta)
values
  ('system_oidc_enabled', 'aktif', 'Aktif', 'false', 10, true, '{"source":"migration","kind":"identity","activation":"requires_it_approval"}'::jsonb),
  ('system_oidc_group_role_sync_enabled', 'aktif', 'Aktif', 'false', 10, true, '{"source":"migration","kind":"identity","activation":"requires_mapping_validation"}'::jsonb)
on conflict (group_key, param_key) do nothing;

update public.system_parameters
set value = 'false', version = version + 1, updated_at = now()
where group_key in ('system_oidc_enabled', 'system_oidc_group_role_sync_enabled')
  and param_key = 'aktif';

update public.system_parameters
set value = 'true', version = version + 1, updated_at = now()
where group_key in ('system_jira_enabled', 'system_jira_weekly_pptx_enabled', 'system_pptx_download_enabled')
  and param_key = 'aktif'
  and meta->>'source' in ('seed', 'migration');

update public.system_parameters
set value = 'false', version = version + 1, updated_at = now()
where group_key = 'system_jira_debug_enabled'
  and param_key = 'aktif';
